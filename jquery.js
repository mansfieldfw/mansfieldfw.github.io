...
function EJV1_setTrackerCode(){
    ...
    if (typeof _gat != "undefined" && typeof ejGATracker != "undefined") {
        EJEJC_ga = 'ga';
        url = EJEJC_PROT + 'checkout.google.com/files/digital/ga_post.js';
    } else if (window.urchinTracker && typeof _ulink != "undefined") {
        if (_ulink == "1") {
            EJEJC_ga = 'urchin';
            url = EJEJC_PROT + 'checkout.google.com/files/digital/urchin_post.js';
        }
    }
